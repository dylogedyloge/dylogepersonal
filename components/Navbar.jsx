  ...
  return (
    <div className="navbar sm:px-96 ">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          >
            ...
            <li tabIndex={0}>
              ...
              <ul className="p-2">
                <li>
                  <a className="bg-base-100 ">Suzo</a>
                </li>
                <li>
                  <a className="bg-base-100">Ecommerce</a>
                </li>
                <li>
                  <a className="bg-base-100">AIDE</a>
                </li>
              </ul>
            </li>
            <li>
        ...
        <a className="normal-case text-xl cursor-pointer font-bold ">Amir</a>
      </div>
